...
namespace CVManagement.Migrations
{
    ...
    [Migration("20260919084420_AddCVAttributeValues")]
    partial class AddCVAttributeValues
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserCVAttribute", b =>
                {
                    ...
                    b.HasKey("CVAttributesID", "UsersId");
            ...
            modelBuilder.Entity("CVCVAttributeValue", b =>
                {
                    b.Property<int>("CVAttributeValuesID")
                        .HasColumnType("integer");

                    b.Property<int>("CVsID")
                        .HasColumnType("integer");

                    b.HasKey("CVAttributeValuesID", "CVsID");

                    b.HasIndex("CVsID");

                    b.ToTable("CVCVAttributeValue");
                });
            ...
            modelBuilder.Entity("CVManagement.Models.Category", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CVManagement.Models.Tag", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CVCVAttributeValue", b =>
                {
                    b.HasOne("CVManagement.Models.CVAttributeValue", null)
                        .WithMany()
                        .HasForeignKey("CVAttributeValuesID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CVManagement.Models.CV", null)
                        .WithMany()
                        .HasForeignKey("CVsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CVManagement.Models.CVAttribute", b =>
                {
                    b.HasOne("CVManagement.Models.Category", "Category")
            ...
            modelBuilder.Entity("PositionTag", b =>
                {
                    ...
                    b.HasOne("CVManagement.Models.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectTag", b =>
                {
                    b.HasOne("CVManagement.Models.Project", null)
                        .WithMany()
